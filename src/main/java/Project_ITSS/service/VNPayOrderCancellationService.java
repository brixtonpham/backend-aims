...
import Project_ITSS.service.OrderCancellationTemplate;
import Project_ITSS.repository.TransactionRepository;
import Project_ITSS.entity.TransactionInfo;
import Project_ITSS.vnpay.dto.RefundRequest;
import Project_ITSS.vnpay.service.VNPayService;
...
import Project_ITSS.event.OrderCancellationEvent;
...
public class VNPayOrderCancellationService extends OrderCancellationTemplate {
    ...
    @Autowired
    @Qualifier("mainTransactionRepository")
